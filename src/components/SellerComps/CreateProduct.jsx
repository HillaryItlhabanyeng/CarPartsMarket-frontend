...
function CreateProduct() {
  ...
  function handleSubmit(e) {
    ...
    newForm.append("vehicleMake", vehicleMake);
    newForm.append("vehicleModel", vehicleModel);
    newForm.append("vehicleYear", vehicleYear);
    newForm.append("engineVariant", engineVariant);
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className={labelClass}>
            Part name <span className="text-danger-500">*</span>
          </label>
          <input
            type="text"
            name="name"
            ...
            placeholder="e.g. Front brake pads Toyota Hilux"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Describe the part, specifications, OEM reference, condition and what is included…"
          />
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              placeholder="OEM, brake pads, Toyota, Hilux"
            />
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-brand-100 bg-brand-50/60 p-5">
          <div className="mb-4">
            <h3 className="font-display text-[16px] font-bold text-ink-900">Vehicle compatibility</h3>
            <p className="mt-1 text-[12px] text-ink-500">Select the vehicle this CarPart fits so buyers can search by compatibility.</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <input className={inputClass} required value={vehicleMake} onChange={e => setVehicleMake(e.target.value)} placeholder="Make e.g. Toyota" />
            <input className={inputClass} required value={vehicleModel} onChange={e => setVehicleModel(e.target.value)} placeholder="Model e.g. Hilux" />
            <input className={inputClass} required type="number" min="1900" max="2100" value={vehicleYear} onChange={e => setVehicleYear(e.target.value)} placeholder="Year e.g. 2018" />
            <input className={inputClass} value={engineVariant} onChange={e => setEngineVariant(e.target.value)} placeholder="Engine / variant" />
        ...
        <div>
          <label className={labelClass}>
            Part images <span className="text-danger-500">*</span>
          </label>
          ...
          <p className="mt-2 text-[12px] text-ink-400">
            The first image becomes the part thumbnail.
          </p>
        </div>
