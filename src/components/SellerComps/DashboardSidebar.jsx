...
const NAV = [
  ...
  { id: 2, to: "/dashboard-orders", label: "Orders", Icon: FiShoppingBag },
  { id: 3, to: "/dashboard-products", label: "My Parts", Icon: FiPackage },
  { id: 4, to: "/dashboard-create-product", label: "Add Part", Icon: AiOutlineFolderAdd },
  { id: 5, to: "/dashboard-withdraw-money", label: "Earnings", Icon: CiMoneyBill },
  { id: 6, to: "/dashboard-messages", label: "Messages", Icon: BiMessageSquareDetail },
  { id: 7, to: "/dashboard-coupons", label: "Discount Codes", Icon: AiOutlineGift },
  { id: 8, to: "/dashboard-refunds", label: "Refunds", Icon: HiOutlineReceiptRefund },
  { id: 9, to: "/dashboard-settings", label: "Settings", Icon: CiSettings },
];
