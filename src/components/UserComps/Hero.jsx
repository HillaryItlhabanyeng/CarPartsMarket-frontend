    ...
    <section className="relative w-full overflow-hidden bg-ink-950">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=1800&auto=format&fit=crop&q=85)",
          }}
        />
      ...
      >
        ...
        >
          Search thousands of car parts from independent sellers. Choose your vehicle, confirm compatibility, compare prices and track your order from checkout to delivery.
        </motion.p>
