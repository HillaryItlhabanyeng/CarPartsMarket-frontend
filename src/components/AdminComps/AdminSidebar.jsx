...
const NAV = [
  ...
  { id: 2, to: "/admin-orders", label: "Orders", Icon: FiShoppingBag },
  { id: 3, to: "/admin-sellers", label: "Sellers", Icon: GrWorkshop },
  { id: 4, to: "/admin-users", label: "Users", Icon: HiOutlineUserGroup },
  { id: 5, to: "/admin-products", label: "Parts", Icon: BsHandbag },
  { id: 6, to: "/admin-vehicles", label: "Vehicle Database", Icon: FiTruck },
  { id: 7, to: "/admin-withdraw-request", label: "Withdraw Requests", Icon: CiMoneyBill },
